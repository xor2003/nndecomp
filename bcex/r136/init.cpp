...
char *roomnames[80] = {"in het bos", "in het bos", "in het bos", "in het moeras", "in het bos",
							  ...
							  "in het bos", "in het bos", "op de open plek", "in het moeras", "in de ruïne",
...
char *roomdesc[80] = { "Je bevindt je in een uithoek van een donker bos. Overal hoor je enge geluiden.",
							  ...
							  "Er hangt een griezelige nevel over het stinkende oppervlak.",
							  "Je bevindt je in een spookachtige ruïne. Er is hier een wankele trap die naar\r\nbeneden leidt.",
							  ...
							  "Een dichte mist belemmert je zicht, en je verliest je orïentatiegevoel.",
...
char blocked[74][2] = {{5, EAST}, {6, WEST}, {11, EAST}, {12, WEST},
							  {18, EAST}, {19, WEST}, {20, EAST},
...
char *itemname[25] = {"het hellehondvlees", "het hittepak", "het groen kristal",
...
char *itemdesc[25] = {"Het is een goor stuk vlees dat naar kots ruikt.",
...
char itemroom[25] = {-1, 4, -1, 5, 13, 20, 22, -1, 24, 27, 31, 39, 40, 43, -1, 51, 52, 60, 61, 62, -1, 70, 72, -1, -1};
