 ...
 ***************************************************************************/
int agetchar(char *allowed);
int ascanf(int chckinp, int length, char *allowed, char *frmstr, ...);
int strinp (char *allowed, char *input, int inpx, int inpy, int caps, int esc, int curm);
