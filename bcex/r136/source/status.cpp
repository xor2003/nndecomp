...
void RodeTrolStatus(Progdata &progdata)
{
	...
	{
	case 0:
      cprintf("Je hebt de rust van de rode trol verstoord. Hij kijkt zwaar ge‰rgerd.\r\n\r\n");
...
void GnoeStatus(Progdata &progdata)
{
	...
	case 1:
		...
		break;
	case 2:
      cprintf("De gnoe ziet het vlees, snuffelt er aan, en slokt het in ‚‚n hap naar binnen.\r\n"
...
void DraakStatus(Progdata &progdata)
{
	...
	case 2:
		...
		break;
	case 3:
		cprintf("De draak grijpt het koekje, en steekt hem gelijk in een van zijn grote bekken.\r\n"
...
void BarbecueStatus(Progdata &progdata)
{
	...
	case 3:
		...
		break;
	case 4:
      cprintf("Een grote rookontwikkeling treedt op wanneer het tweede ingredi‰nt in de\r\n"
				  "barbecue belandt.\r\n"
...
void DiamantStatus(Progdata &progdata)
{
	...
	{
	case 0:
      cprintf("Je struikelt over iets. Door de begroe‹ing zie je niet wat het is.\r\n\r\n");
