...
{
	clrscr();
	cprintf("Terwijl je op het punt staat je avontuur te beginnen, denk je nog even na\r\n"
	...
	getch();
	clrscr();
	cprintf("Hij vond dat de wereld de schuld had van zijn mutaties en hij wilde de\r\n"
