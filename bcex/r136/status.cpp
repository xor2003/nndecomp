...
void RoomStatus(Progdata &progdata)
{
	...
	if (progdata.status.curroom != 61 && progdata.status.curroom != 31 && progdata.status.curroom >= 20 && !progdata.status.lamp)
		cprintf("Het is stekedonker en je ziet geen hand voor ogen.\r\n");
	else
	{
...
bool BeastStatus(Progdata &progdata)
{
	...
	case VACUUM:
		cprintf("Doordat er in deze grot geen lucht is, klappen allebei je longen dicht. Een\r\n"
	...
	case MIDDENMOERAS:
	case ZUIDMOERAS:
		cprintf("Met de eerste stap die je in het moeras zet, voel je dat je geen vaste grond\r\n"
		...
		return false;
	case MISTGROT:
		cprintf("In deze grot hangt een vreemde, dichte mist, waardoor je geen hand voor ogen\r\n"
				  "ziet. Je verliest je orïentatiegevoel en stommelt paniekerig door de grot, op\r\n"
		...
		return false;
	case TELEPORT:
		cprintf("Als je deze grot binnenloopt zie je een aantal pulserende lampen aan het\r\n"
...
void HellehondStatus(Progdata &progdata)
{
	...
	{
	case 0:
		cprintf("Er staat hier een reusachtige hellehond die je de weg verspert. Zijn scherpe\r\n"
		...
		break;
	case 1:
		cprintf("De hellehond zet zich af tegen de grond, en hij spring boven op je lijf. Zijn\r\n"
		...
		break;
	case 2:
		cprintf("De honger van de hellehond is nog niet gestild. Een diep gegrom komt uit zijn\r\n"
				 "keel, en hij staat klaar om opnieuw aan te vallen.\r\n\r\n");

		progdata.living[HELLEHOND].status = random(2) + 1;
		break;
	case 3:
		cprintf("Door de wonden aangericht met je zwaard sterft de hevig bloedende hellehond. Je\r\n"
		...
		break;
	case 4:
		cprintf("De dode hellehond ligt in een bad van dampend bloed.\r\n\r\n");
		break;
	}
}
...
void RodeTrolStatus(Progdata &progdata)
{
	...
	{
	case 0:
		cprintf("Je hebt de rust van de rode trol verstoord. Hij kijkt zwaar geërgerd.\r\n\r\n");

		progdata.living[RODETROL].status = 1;
		break;
	case 1:
		cprintf("Nu is de trol pas echt goed wakker. Hij pakt zijn zweep en komt dreigend op je\r\n"
				 "af.\r\n\r\n");

		progdata.living[RODETROL].status = 2;
		break;
	case 2:
		cprintf("De trol deelt je een harde klap uit met z'n zweep. Je voelt de brandende pijn\r\n"
		...
		break;
	case 3:
		cprintf("Het schuim loopt uit de trol z'n bek. Hij heft opnieuw zijn zweep.\r\n\r\n");

		progdata.living[RODETROL].status = random(2) + 2;
		break;
	case 4:
		cprintf("Opgewonden grijpt de trol het boekje. Hij bladert het door, en wordt roder en\r\n"
		...
		break;
	case 5:
		cprintf("Overal in de grot liggen stukken van de verscheurde trol verspreid. Het slijm\r\n"
...
void PlantStatus(Progdata &progdata)
{
	...
	{
	case 0:
		cprintf("In deze grot leeft een vleesetende plant. Zijn dikke groene stengel loopt uit\r\n"
		...
		break;
	case 1:
		cprintf("De plant likt met zijn kleine schurfterige tongetje je bloed van zijn bek.\r\n"
		...
		break;
	case 2:
		cprintf("Opnieuw omsluit de bek van de plant je hals. Een warme stroom bloed loopt via\r\n"
		...
		break;
	case 3:
		cprintf("De resten van wat eerst een vleesetende plant was liggen nu op de grond van\r\n"
		...
		break;
	case 4:
		cprintf("De vleesetende plant is niet veel meer dan een berg stinkend tuinafval.\r\n\r\n");
...
void GnoeStatus(Progdata &progdata)
{
	...
	{
	case 0:
		cprintf("Er staat hier een grote behaarde gnoe die je met twee geniepige oogjes aan-\r\n"
		...
		break;
	case 1:
		cprintf("De gnoe neemt een sprong, en stoot met zijn grote kop hard in je maag. Je\r\n"
		...
		break;
	case 2:
		cprintf("De gnoe ziet het vlees, snuffelt er aan, en slokt het in één hap naar binnen.\r\n"
		...
		break;
	case 3:
		cprintf("Het bultachtige lichaam van de gnoe ligt op de grond en de hersens liggen er\r\n"
				 "als een papje naast.\r\n\r\n");
...
void DraakStatus(Progdata &progdata)
{
	...
	{
	case 0:
		cprintf("In deze grot bevindt zich een grote draak. Hij heeft meerdere koppen, die je\r\n"
		...
		break;
	case 1:
		cprintf("De koppen van de draak bewegen nu agressiever heen en weer en beginnen hevig\r\n"
				 "te snuiven.\r\n"
		...
		break;
	case 2:
		cprintf("De draak heft langzaam een van zijn gore poten op, en geeft opeens een ontzet-\r\n"
		...
		break;
	case 3:
		cprintf("De draak grijpt de koekjes, en steekt ze gelijk in een van zijn grote bekken.\r\n"
				 "Langzaam begint hij te wankelen, en met een doffe dreun klapt hij op de grond.\r\n"
				 "Uit de bek waar juist de koekjes in verdwenen druipt wat kwijl. De draak\r\n"
				 "slaapt.\r\n\r\n");

		progdata.living[DRAAK].status = 4;
		break;
	case 4:
		cprintf("De draak slaapt onrustig. Soms beweegt een van zijn koppen iets, en uit zijn\r\n"
				 "lijf klinkt een diep gegrom.\r\n\r\n");

		break;
	case 5:
		cprintf("Voorzichtig zet je de draak de slaapmuts op. De vrolijke kleuren van de muts\r\n"
		...
		break;
	case 6:
		cprintf("De draak slaapt rustig.\r\n\r\n");
...
void GezwelStatus(Progdata &progdata)
{
	...
	{
	case 0:
		cprintf("Er staat hier een wezen dat nog het meest lijkt op een gezwel. Het kijkt je\r\n"
		...
		break;
	case 1:
		cprintf("Het gezwel zit nog steeds aan de grotwanden vastgezogen, en het trilt licht.\r\n\r\n");
	...
	case 2:
		...
		// gasmasker op
		{
			cprintf("Als je op de hendel drukt, zie je een bruingrijs gas uit het patroon spuiten.\r\n"
		...
		// geen masker... oeps!
		{
			cprintf("Je kunt nog zien dat het gezwel langzaam steeds heftiger begint te trillen,\r\n"
		...
		break;
	case 4:
		cprintf("Op het gescheurde lichaam van het gezwel zitten allemaal schimmels. Uit zijn\r\n"
...
void DeurStatus(Progdata &progdata)
{
	...
	{
	case 0:
		cprintf("In het noorden zit een grote, vastgeroeste deur. Hij is met blote handen niet\r\n"
				 "meer open te krijgen.\r\n\r\n");

		break;
	case 1:
		cprintf("Je zet 1 eind van het bot onder de deur, en op het andere begin je te duwen.\r\n"
		...
		break;
	case 2:
		cprintf("De deur is nu open, en geeft toegang tot een grot.\r\n\r\n");
...
void StemmenStatus(Progdata &progdata)
{
	...
	{
	case 0:
		cprintf("Uit het niets hoor je opeens een paar stemmen. Met moeite kun je ze verstaan:\r\n"
		...
		break;
	case 1:
		cprintf("Vanuit de verte hoor je zachte, lachende stemmetjes.\r\n\r\n");
...
void BarbecueStatus(Progdata &progdata)
{
	...
	{
	case 0:
		cprintf("Op deze open plek staat een barbecue gezellig te branden.\r\n\r\n");

		break;
	case 1:
		cprintf("Als je de hasj op de barbecue gooit verschiet de vlam van kleur. Verder gebeurt\r\n"
				  "er niets.\r\n\r\n");

		progdata.living[BARBECUE].status = 3;
		break;
	case 2:
		cprintf("Als je het vlees op de barbecue gooit verschiet de vlam van kleur. Verder\r\n"
				  "gebeurt er niets.\r\n\r\n");

		progdata.living[BARBECUE].status = 3;
		break;
	case 3:
		cprintf("De barbecue brandt nog steeds, alleen iets onrustiger dan eerst.\r\n\r\n");

		break;
	case 4:
		cprintf("Een grote rookontwikkeling treedt op wanneer het tweede ingrediënt in de\r\n"
				  "barbecue belandt.\r\n"
...
void BoomStatus(Progdata &progdata)
{
	...
	{
	case 0:
		cprintf("In een kleine open plek staat een grote, kurkdroge, dode boom. Op de stam zit\r\n"
				 "een bordje met daarop de tekst \"Roken en open vuur verboden\".\r\n\r\n");

		break;
	case 1:
		cprintf("Uit de pijp van de vlammenwerper spuit een enorme vlam. De boom begint langzaam\r\n"
		...
		{
			cprintf("Je hebt niets om je te beschermen tegen de hitte, en je loopt flinke brandwon-\r\n"
					 "den op.\r\n\r\n");
		...
		break;
	case 2:
		cprintf("Uit de grond steken nog een paar wortels, en er naast ligt een verkoold stuk\r\n"
...
void DiamantStatus(Progdata &progdata)
{
	...
	{
	case 0:
		cprintf("Je struikelt over iets. Door de begroeïing zie je niet wat het is.\r\n\r\n");
...
void ComputerStatus(Progdata &progdata)
{
	...
	{
	case 0:
		cprintf("Er staat een computer van het merk Beull die bestaat bestaat uit een kast met\r\n"
		...
		break;
	case 1:
		cprintf("De computer wacht nog steeds.\r\n\r\n");

		break;
	case 2:
		cprintf("De drive begint te lezen en na korte tijd verschijnt er informatie op het\r\n"
		...
		break;
	case 3:
		cprintf("Er valt niets te zien op de monitor en de computer is stil.\r\n\r\n");
...
void DrakeKopStatus(Progdata &progdata)
{
	...
	{
	case 0:
		cprintf("Er zit in het noorden een zware, dichte deur met daarnaast een drakekop met een\r\n"
				 "geopende muil. Op de deur zit een zwaar slot.\r\n\r\n");

		break;
	case 1:
		cprintf("Je stopt het kristal in de muil van de drakekop, die daarop dicht- en weer\r\n"
		...
		break;
	case 2:
		cprintf("De ogen van de draak blijven licht gloeien.\r\n\r\n");

		break;
	case 3:
		cprintf("Je stopt nog een kristal in de muil. Weer sluit en opent deze, en weer is het\r\n"
				 "kristal verdwenen. Het schijnsel uit de ogen wordt nu sterker.\r\n\r\n");

		progdata.living[DRAKEKOP].status = 4;
		break;
	case 4:
		cprintf("De ogen van de draak blijven gloeien.\r\n\r\n");

		break;
	case 5:
		cprintf("Je legt het laatste kristal in de kop. De muil sluit zich weer, en nu blijft\r\n"
		...
		break;
	case 6:
		cprintf("De zware deur is nu open en geeft toegang tot een ruimte.\r\n\r\n");
...
bool LavaStatus(Progdata &progdata)
{
	...
	case 0:
		if (progdata.items[HITTEPAK].room == -2)
			cprintf("Voor je zie je een krater waarin lava opborrelt. Van het lava komt een dikke\r\n"
					 "damp, en een rode gloed verlicht de omtrek. De hitte is enorm, maar het hitte-\r\n"
					 "pak beschermt je tegen verbranding.\r\n\r\n");
		else
		{
			cprintf("Voor je zie je een krater waarin lava opborrelt. De hitte is zo intens, dat je\r\n"
		...
		return true;
	case 1:
		cprintf("Je gooit de positronenbom met een pisboogje in de lava. Met luid gesis zakt\r\n"
...
void PapierStatus(Progdata &progdata)
{
	...
	{
	case 0:
		cprintf("Er zit een dicht, houten luik in het plafond. Je kunt er niet bij.\r\n\r\n");

		break;
	case 1:
		cprintf("Het luik in het plafond gaat open en er dwarrelt een vel papier naar beneden.\r\n\r\n");

		progdata.items[PAPIERITEM].room = 66;
		progdata.living[PAPIER].status = 2;
		break;
	case 2:
		cprintf("Het luik aan het plafond hangt nu open. Er zit een leeg gat.\r\n\r\n");
